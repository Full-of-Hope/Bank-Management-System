...
void accountlist::on_accountlist_searchEdit_textChanged(const QString &arg1)
{
    ...
    ui->accountlist_tableView->setColumnWidth(0, 100);
    ...
    ui->accountlist_tableView->setColumnWidth(5, 200);
    ...
    for (int i = 0; i < iNumberOfAccounts; i++)
    {
            ...
            bankserver.GetOperator(i).find(strSearchString) != string :: npos)
        {
            ...
            model->setItem(iItemsFinded, 6, new QStandardItem(QString::fromStdString(bankserver.GetOperatornum(i))));
            model->setItem(iItemsFinded, 7, new QStandardItem(QString::fromStdString(bankserver.GetOperator(i))));
        }
    }
...
void accountlist::SetDefault()
{
    ...
    ui->accountlist_tableView->setColumnWidth(3, 80);
    ui->accountlist_tableView->setColumnWidth(4, 80);
    ui->accountlist_tableView->setColumnWidth(5, 120);
    ui->accountlist_tableView->setColumnWidth(6, 80);
    ui->accountlist_tableView->setColumnWidth(7, 80);
    ...
    for (int i = 0; i < iNumberOfAccounts; i++)
    {
        ...
        model->setItem(i, 6, new QStandardItem(QString::fromStdString(bankserver.GetOperatornum(i))));
        model->setItem(i, 7, new QStandardItem(QString::fromStdString(bankserver.GetOperator(i))));
    }
}
